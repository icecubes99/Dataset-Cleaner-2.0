...
class StratifiedCommentSampler:
    ...
    def __init__(self, input_file="cleaned_for_annotation_v2.csv", 
        ...
        # Output file names
        self.annotation_output_file = "dataset_for_annotation.csv"
        self.archive_output_file = "unlabeled_archive.csv"
...
def create_annotation_dataset(input_file="cleaned_for_annotation_v2.csv", 
...
if __name__ == "__main__":
    ...
    INPUT_FILE = "cleaned_for_annotation_v2.csv"
